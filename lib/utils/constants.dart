...
class Constants {
  ...
  // static const String _common = 'http://192.168.100.97:3000';//local
  static const String _common = 'http://34.223.102.186/apis'; //local
  static const String baseUrl = "$_common/api/";
  // static const String baseUrl = "http://34.223.102.186/apis/api/";
